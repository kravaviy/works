...
/* Background Overlay */
var bgOverlayImg = 'url(images/pattern-light.png)'; //You may also set pattern-dark.png here, if you need darker video.
var bgOverlayColor = '#000000';
var bgOverlayOpacity = '0.2'; // Set 0 if you do't need to overlay color
